...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/formulas_venta.css" title="Style">
        <!-- Estilos  -->
         <!-- Js -->
        ...
        <!-- Saldo -->
        <script language="JavaScript" type="text/javascript" src="js/operaciones_extra.js"></script>
    </head>
    <body>
            ...
            <!-- CONTAINER DE NAVEGACIÓN -->
                ...
                <div class="container">
                 ...
                 <div class="title">
                    ...
                    <br><br>
                    <div id="content_facturas_a_vencer_compra">
                        <div id="frm_vence">
                            <div class="titulo">Facturas compra a vencer</div>
                            <div class="hidden" id="datafacturas_vencer">
                                <div class="encabezado_vencer">
                                    <div class="numero_factura"># Factura</div>
                                    <div class="fecha_pago">Fecha</div>
                 ...
                 <!-- END *** TABS DE NAVEGACIÓN  *** END -->
                   ...
                   <!--  VENTA -->
                 <div class="frame isVisible" id="frmVenta">

                     <!-- Buscar formula para setear en data grid  -->
                     <div id="frm_buscar_formula" class="hidden" data-estado="0">
                         <div class="titulo_formula">
                             <div class="label">Buscar fórmula</div>
                         </div>
                         <div class="fila_formula">
                                        <div id="cell_maquina" class="cell_formula hidden" >
                                            ...
                                            <div class="buscador" id="buscador_maquina">
                                                <div class="label" id="lbl_select_maquina">Marca</div>
                                                <div class="textbox"><input id="txt_buscador_maquina" data-id="0" placeholder=""></div>
                                                <div class="list" id="listMaquina"></div>
                                            </div>
                                        </div> <!-- Máquina -- Fin -->
                                        <!-- Fórmula --  -->
                                        <div id="cell_formula" class="cell_formula">
                                            ...
                                            <div class="buscador" id="buscador_formula">
                                                <div class="textbox"><input id="txt_buscador_formula" placeholder=""></div>
                                                <div class="list hidden" id="listFormula"></div>
                                                <!-- Eliminar formula -->
                                                    <div class="content_button">
                                                        <div id="btn_eliminar_formula" class="button">
                                                            <div class="label">Eliminar formula</div>
                                                        </div>
                                                    </div>
                                                <!-- Eliminar formula -->
                                            </div>
                                             <div class="setter" id="setterFormula">
                                                        ...
                                                        <div class="content_button">
                                                            <div id="btn_formula_rapida" class="button">
                                                                <div class="label">Rápida</div>
                                                            </div>
                                                            <div id="btn_formula_permanente" class="button">
                                                                <div class="label">Permanente</div>
                                                            </div>
                                        ...
                                        <div id="cell_setter_formula" class="cell_formula">
                                            <div class="align">
                                                  ...
                                                  <div class="field_formula">
                                                       ...
                                                       <div class="textbox"><input id="txtPrecio_formula" placeholder="$10.000"></div>
                                                   </div>
                                            </div>
                     ...
                     <div class="marco" id="mVenta">
                          ...
                          <div id="s_busqueda_cliente" class="sector">
                              ...
                              <div class="fila" id="fila_cliente">
                                     <div class="cell">
                                         ...
                                         <div class="value" id="data_documento">...</div>
                                     </div>
                                     <div class="cell">
                                         <div class="label">Ciudad</div>
                                         <div class="value" id="data_city">...</div>
                                     </div>
                                     <div class="cell">
                                         <div class="label">Telefono</div>
                                          <div class="value" id="data_telefono">...</div>
                                     </div>
                                     <div  id="data_direccion">...</div>
                                 </div>
                       ...
                       <!-- SECTOR: BÚSQUEDA CLIENTES -->
                           ...
                           <div id="content_saldo">
                              <div class="setter_saldo hidden" id="setter_saldo">
                                  <div class="row">
                                    <div class="field">
                                        <div class="label"> Saldo cliente</div>
                                        <div class="textbox">
                                          <input type="text" name="" value="" id="txtSaldo_cliente" placeholder="">
                                        </div>
                                    </div>
                                    <div class="field">
                                        <div class="label">Responsable</div>
                                        <div class="textbox">
                                          <input type="text" name="" value="" id="txtResponsable" placeholder="">
                                        </div>
                                    </div>
                                  </div>
                                  <div class="content_button_saldo">
                                      <div id="btn_add_saldo" class="button_saldo">
                              ...
                              <div class="titulo_saldo">
                                  <label class="cell">Saldo</label>
                                  <label class="cell">Fecha</label>
                              </div>
                              <div class="row_saldo">
                                  <label id="valor_saldo" class="cell">--</label>
                                  <label id="fecha_saldo" class="cell">--</label>
                              </div>
                              <div class="content_button_saldo">
                                  <div id="btn_open_saldo" class="button_saldo">
                                      <div class="label">+</div>
                                  </div>
                              </div>
                            <!--   <div class="msj">Ya se puede agreagar saldo... an no esta asociado a la factura que se esta vendiendo...</div> -->
                           </div>
                       ...
                       <br><br>
                            ...
                            <!-- Resumen de factura -->
                                ...
                                <div id="resumen_factura" >
                                    ...
                                    <div class="encabezado_rf">Devolucion</div><br>
                                    <!-- Devolucion -->
                                    <div class="fila_rf">
                            ...
                            <div id="finalizar_factura">
                                        <!-- Pago factura -->
                                        <div id="pago_factura" class="hidden">
                                        ...
                                        <div id="contenido_factura">
                                                    ...
                                                    <div id="f_Factura_detalle">
                                                        ...
                                                        <div class="encabezado">
                                                            ...
                                                            <div class="descripcion_factura">
                                                                    ...
                                                                    <!-- Eliminar factura -->
                                                                    <div id="btnEliminar_factura" class="field">
                                                                        <div class="label">Eliminar Factura</div>
                                                                    </div>
                                                            </div>
                                                    ...
                                                    <div id="f_Pendientes">
                                                        ...
                                                        <div class="encabezado">
                                                            ...
                                                            <!-- Facturas pendientes -->
                                                            <div id="list_facturas_pendientes">
