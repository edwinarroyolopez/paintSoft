              ...
              <link type="text/css" rel="stylesheet" href="css/new/compra.css" title="Style">
                <link type="text/css" rel="stylesheet" href="css/new/factura.css" title="Style">
                  <link type="text/css" rel="stylesheet" href="css/new/controllers.css" title="Style">
                    ...
                    <link type="text/css" rel="stylesheet" href="css/inventario/filtro.css" title="Style">
                  ...
                  <body>
                    ...
                    <div id="universe" spellcheck="false">
                      ...
                      <div id="center">
                        ...
                        <!-- Content tab -->
                        <div class="content_tab" id="content_filtro">
                          <div class="head">Filtros</div>
                          <div class="tab"  id="filtro_producto" style="border-left: 1px solid #e9eaed;">
                            <span class="text">Producto</span>
                          </div>
                          <div class="tab" id="filtro_marca">
                            <span class="text">Marca</span>
                          </div>
                          <div class="tab" id="filtro_grupo">
                            <span class="text">Grupo</span>
                          </div>
                          <div class="tab" id="filtro_realizados">
                            <span class="text">Realizados</span>
                          </div>
                          <div class="tab" id="filtro_restantes">
                            <span class="text">Restantes</span>
                          </div>
                        </div>
                        ...
                        <div id="frame">
                          ...
                          <div class="content" id="content_detalle_filtro">
                            <div id="selectedFiltro"></div>
                            <!-- 1. Filtro por producto -->
                            <div id="content_filtro_producto" class="">
                            ...
                            <!-- 2. Filtro por marca -->
                            <div id="content_filtro_marca" class="">
                              <div class="content_search" id="content_search_producto">
                                <div class="searcher">
                                  <div class="fieldSearch">
                                      <input type="text" name="" id="txt_search_marca" value="" placeholder="..." />
                                      <div class="label" id="selectedMarca" data-id="0">Buscar marca</div>
                                  </div>
                                  <div class="list hidden" id="listMarca"></div>
                                </div>
                              </div>
                              <div  id="detalle_producto">
                                  <div class="info" id="info_grupo">
                            ...
                            <!-- 3. Filtro por grupo -->
                            <div id="content_filtro_grupo" class="">
                              <div class="content_search" id="content_search_producto">
                                <div class="searcher">
                                  <div class="fieldSearch">
                                      <input type="text" name="" id="txt_search_grupo" value="" placeholder="..." />
                                      <div class="label" id="selectedProducto" data-id="0">Buscar grupo</div>
                                  </div>
                                  <div class="list hidden" id="listGrupo"></div>
                                </div>
                              </div>
                              <div  id="detalle_producto">
                                  <div class="info" id="info_grupo">
