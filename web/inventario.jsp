...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/inventario/filtro.css" title="Style">
        <!-- Estilos  -->
         <!-- Js -->
        ...
        <div id="Inventario">
            ...
            <div id="setcantidad_producto">
                ...
                <div id="select_cantidad">
                    ...
                    <div id="message_peso">mensaje</div>
                </div>
            ...
            <br>
                                ...
                                <div class="cell_sector hidden" id="cell_producto" >
                                                ...
                                                <div class="align">
                                                        ...
                                                        <div class="field">
                                                            ...
                                                            <div class="textbox"><input id="txtPrecioCompra" placeholder="10.000" type="text"></div>
                                                        </div>
                                                </div>
                                                <div class="align">
                                                    <div class="field">
                        ...
                        <br>
                          <div class="content_data">
                              <div class="datagrid" id="dataInventario">
                                  <div class="head">
                                      <div class="cell descripcion">Descripcion</div>
                                      <div class="cell presentacion">Presentacion</div>
                                      <div class="cell stock">Stock</div>
                                      <div class="cell estado">Inventariado</div>
                                      <div class="cell fecha_modificacion">Ultimo inventario</div>
                                      <div class="cell precio_venta">Precio venta</div>
                                      <div class="cell precio_compra">Precio compra</div>
                                  </div>
                              </div>
                          </div>
