 ...
 function set_list_productos_venta(json_productos){
                        ...
                        console.log('cargando productos en la lista!');
   ...
   /*  setInterval(function(){
    ...
    getProductos().then(function(productos){
        /* Variable global de productos*/
            productos = jQuery.parseJSON($.trim(productos));
        /* Lista de productos: Venta */
            set_list_productos_venta(productos);
        /* Lista de productos para configurar precios */
            setProductos_configuracion(productos);
    })

    /* Trae presentaciones de un producto */
                          ...
                          getPresentaciones(id_producto).then(function(presentaciones){
                                ...
                                for (i in presentaciones){
                                    /* Filtrar - Actualizar Stock */
                                       var item = document.createElement('div');
                                       item.setAttribute('class','item');
                                       item.setAttribute('data-id_unidad_medida',presentaciones[i].Id);
                                       item.setAttribute('data-precio',presentaciones[i].Precio_venta);
                                       item.setAttribute('data-iva',presentaciones[i].Iva);
                                       var unidad = document.createElement('div');
                                       unidad.setAttribute('class','unidad');
                                       unidad.innerHTML = presentaciones[i].Unidad_medida;
