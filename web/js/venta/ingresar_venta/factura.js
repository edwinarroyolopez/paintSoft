...
function Facturar(encabezado,detalle_producto,detalle_formula){
    ...
    var response = {};
     var promise = new Promise(function (resolve, reject) {
                 ...
                 $.post('ctrlfactura',{Action:6,JSON_encabezado:encabezado,
                                      JSON_detalle_producto:detalle_producto,
                                      JSON_detalle_formula:detalle_formula}, function(r){/* Callback ...   */
                       if(r != ''){
                         response = r;
                       }
                       resolve(response)
                ...
                var json_detalle_cotizacion =  JSON.stringify(get_json_detalle_producto_cotizacion());
                    ...
                    console.log('Archivo '+archivo);
                     ...
                     $.post('ctrlcotizacion',{A:1,JSON_encabezado:json_encabezado_cotizacion,
                                       JSON_detalle_producto:json_detalle_cotizacion,Archivo:archivo},function(r){ });
