$(document).on('ready', function(){
    ...
    /* Carga las capturas facturas de compra */
    
    carga_captura_factura_compra();
    
    function carga_captura_factura_compra(){
        
        $.post('ctrlfactura',{Action: 15},
         function(r){/* Captura factura  */
                        ...
                        for(i in json){
                             var fila = document.createElement('div');
                                 ...
                                 fila.setAttribute('data-id',json[i].Id);
                                  /* numero_factura */    
                            var numero_factura = document.createElement('div');    
                                numero_factura.setAttribute('class','numero_factura');
                                numero_factura.innerHTML = json[i].Numero_factura;

                            var proveedor = document.createElement('div');    
                                proveedor.setAttribute('class','proveedor');
                                proveedor.innerHTML = json[i].Proveedor;

                           var valor_factura = document.createElement('div');    
                               valor_factura.setAttribute('class','valor_factura');
                               valor_factura.innerHTML = json[i].Valor_factura;
                           
                           var fecha_pago = document.createElement('div');    
                               fecha_pago.setAttribute('class','fecha_pago');
                               fecha_pago.innerHTML = json[i].Fecha_pago;
                           
                           var estado = document.createElement('div');    
                               estado.setAttribute('class','estado');
                               estado.innerHTML = json[i].Estado;
                                
                                fila.appendChild(numero_factura);
                                fila.appendChild(proveedor);
                                fila.appendChild(valor_factura);
    ...
    $('div#datagrid_detalle_factura').on('click','div.fila',function(){
        ...
        var proveedor = $(this).children('div.proveedor').html();
        var id_factura = $(this).attr('data-id');
        var numero_factura = $(this).children('div.numero_factura').html();
        var valor_factura = $(this).children('div.valor_factura').html();
        var fecha_pago = $(this).children('div.fecha_pago').html();
        var estado = $(this).children('div.estado').html();
        
        document.getElementById('info_proveedor').innerHTML = proveedor;
        document.getElementById('info_numero_factura').setAttribute('data-id',id_factura);
        document.getElementById('info_numero_factura').innerHTML = numero_factura;
        document.getElementById('info_valor_factura').innerHTML = valor_factura;
        document.getElementById('info_fecha_pago').innerHTML = fecha_pago;
        document.getElementById('info_estado').innerHTML = estado;
        
    });
    
     $('div#btnCerrar').on('click',function(){
         
        var id_factura = document.getElementById('info_numero_factura').getAttribute('data-id');
     
         $.post('ctrlfactura',{Action: 16,Id_factura:id_factura},function(r){/* Captura factura  */
              console.log(r);
         });
         
     });
     $('div#btnBorrar').on('click',function(){
         
         
          var id_factura = document.getElementById('info_numero_factura').getAttribute('data-id');

         $.post('ctrlfactura',{Action: 17,Id_factura:id_factura},function(r){/* Captura factura  */
              console.log(r);
         });
     });
    ...
    $('div#btnAlmacenar').on('click',function(){
        
        var numero = document.getElementById('txtNumero').value;
        var fecha_ingreso = document.getElementById('txtFecha_ingreso').value;
        var fecha_pago = document.getElementById('txtFecha_pago').value;
        ...
        var valor_factura = document.getElementById('txt_valor_factura').value;
        
        
        $.post('ctrlfactura',{Numero: numero,Fecha_ingreso:fecha_ingreso,
                              Fecha_pago:fecha_pago,Proveedor:proveedor,
                              Id_proveedor:id_proveedor,Valor_factura:valor_factura,Action: 14},
         function(r){/* Captura factura  */
                /* Limpiar campos */
                       document.getElementById('txtNumero').value = '';
                       fechaFactura();/* Fecha ingreso */
                       document.getElementById('txtFecha_pago').value = '';
                       document.getElementById('txtProveedor').value = '';
                       document.getElementById('txtProveedor').setAttribute('data-id',0);
                       document.getElementById('txt_valor_factura').value = '';             
        });
    ...
    function fechaFactura(){
        ...
        if(dd<10) {dd='0'+dd} 
        if(mm<10) {mm='0'+mm} 
        document.getElementById('txtFecha_ingreso').value = dd+'/'+mm+'/'+yyyy;
                ...
                var tab = $(this).text();
                        ...
                        switch(tab){
                            ...
                            case 'Opcion 3': 
                                ...
                                break;
                            case 'Capturar Factura': 
                                    $('div#frmCapturarFactura').addClass('isVisible');
                                break;
                            case 'Estado de factura': 
                                    $('div#frmEstado_factura').addClass('isVisible');
                                break;
                            default:
    ...
    $('div#frmCapturarFactura').on('focusin','input#txtProveedor',function(){
        $('div#cbProveedor').css('display','block');
    });
    /* Focus Out: Desaparece */
     $('div#frmCapturarFactura').on('focusout','input#txtProveedor',function(){
        setTimeout(function(){$('div#cbProveedor').css('display','none');},200);
    });
...
//                   }
    ...
    /* Cargar id de última factura */
    
    function cargaIdFactura(){
        ...
        $.post('ctrlfactura',{
                              ...
                              document.getElementById('txtNumero').setAttribute('data-id',jSon.Id_encabezado);
             });
    }
