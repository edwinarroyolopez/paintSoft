...
public class ctrlFactura extends HttpServlet {
        ...
        switch (pmtAction) {
            ...
            case 6:/* ALMACENAR: ---> ENCABEZADO: Factura de venta  */
                ...
                try {
                    ...
                    pmtHora = String.valueOf(json_encabezado.get("Hora"));
 ...
 /* Condición Forma de pago */
                    ...
                    ///  InputStream is = getServletContext().getResourceAsStream("/FMontelibano.pdf");
                    PdfReader reader = new PdfReader(is, null);
                    ByteArrayOutputStream baos = new ByteArrayOutputStream();
                    PdfStamper stamper = new PdfStamper(reader, baos);
                    AcroFields fields = stamper.getAcroFields();
                    /* Trae campos de la plantilla */
 ...
 /* Cambiar fuente 
                    ...
                    fields.setField("Subtotal", formatea.format(pmtTotal - pmtIva));
 ...
 /* Control posiciones en pdf */
                    ...
                    for (int i = 0; i < list_json_detalle_formula.size(); i++) {
                        ...
                        System.out.println("Antes de setDetalle_formula...");
                        ...
                        fields.setField("Unidad_" + j, (String) json_detalle_formula.get("Unidad"));
                        ...
                        fields.setField("Descuento_" + j, String.valueOf(json_detalle_formula.get("Descuento")));
                    ...
                    System.out.println("Detalle prodcutos - antes del for ");
                    ...
                    for (int i = 0; i < list_json_detalle_producto.size(); i++) {
                        ...
                        System.out.println("despues de: Id_producto -  Id_unidad -  Tipo - Id_fraccion");
                        ...
                        System.out.println("despues de: Cantidad -  Precio_unidad -  Descuento - Iva");
                        ...
                        System.out.println("Antes de insertar detalle factura en PDF");
                        ...
                        System.out.println("Despues de: Codigo - Descripcion - Unidad");
                        ...
                        fields.setField("Descuento_" + j, String.valueOf(json_detalle_producto.get("Descuento")));
                        fields.setField("Precio_" + j, formatea.format(Precio));
                        System.out.println("Despues de: PUnidad - Cantidad - Descuento");
                    }
            ...
            case 11:
                ...
                break;
            case 12:
                /* Get detalle facturas de compra */
                pmtId_factura = Integer.parseInt(request.getParameter("Id_factura"));
            ...
            case 13:
                ...
                pmtId_factura = Integer.parseInt(request.getParameter("Id_factura"));
                String result = OpFacturaDetalle.Eliminar_factura_venta(pmtId_factura);
                response.getWriter().write(result);

                break;
            case 14:
                /*Captura factura compra */
                ...
                String Valor_factura = request.getParameter("Valor_factura");

                String resultado = OpFacturaDetalle.Captura_factura_compra(Numero, Fecha_ingreso, Fecha_pago, Proveedor, Id_proveedor, Valor_factura);
                response.getWriter().write(resultado);

                break;

            case 15:
                /* Carga captura de facturas  */
                String json_captura_factura = OpFacturaDetalle.carga_Captura_factura_compra();
                response.getWriter().write(json_captura_factura);
                break;

            case 16:
                /* Cierra factura */
                Id_factura = request.getParameter("Id_factura");
                String res = OpFacturaDetalle.cerrar_factura(Id_factura);
            ...
            case 17:
                /* Cierra factura */
                Id_factura = request.getParameter("Id_factura");
                String resp = OpFacturaDetalle.borrar_factura(Id_factura);
                response.getWriter().write(resp);
                break;
            case 18:
                /* Buscar facturas a vencer */
                String rs = OpFacturaDetalle.buscar_facturas_a_vencer();
                response.getWriter().write(rs);
                break;
            case 19:
                /* Buscar facturas a vencer */
                pmtId_cliente = Integer.parseInt(request.getParameter("id_cliente"));
                String rsf = OpFacturaEncabezado.getFacturasByIdCliente(pmtId_cliente);
                response.getWriter().write(rsf);
                break;
            case 20:
                /* Cerrar facturas */
                String ids_factura =  request.getParameter("ids_factura");
                String rsfi = OpFacturaEncabezado.setCerrarFacturas(ids_factura);
                response.getWriter().write(rsfi);
                break;
            default:
                break;
